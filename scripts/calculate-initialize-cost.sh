#!/usr/bin/env bash
# Initialize cost calculator for the splitter program.
...
log "=== splitter Initialize Cost Calculation ==="
...
echo
log "Notes:"
log "  • Paid up-front by the payer (must be DEPLOYER) in a single initialize tx."
